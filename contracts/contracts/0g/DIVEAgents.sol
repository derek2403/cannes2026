...
/// @title DIVE Agents — ERC-7857 INFT + Cron + x402
/// @notice Autonomous economic agents on 0G Chain.
contract DIVEAgents is ERC721, Ownable {
    ...
    constructor(address _verifier) ERC721("DIVE Agents", "DIVE") Ownable(msg.sender) {
